...
nsecs_t bot_tracker::process(Mat& f)
{
        ...
        // calcula la diferencia del frame con el fondo.
        cv::absdiff(gray0, background_gray, gray1);
        // convierte la diferencia a binario: todo lo blanco
        // son robots potenciales, el resto es fondo.
        cv::threshold(gray1, gray1, threshold, 255, CV_THRESH_BINARY);
